<template>
    <div class="earn">
        <div class="custom_head">
            <page-header style="position: fixed;top: 0;left: 0; z-index: 9;" title="下线管理" :show-icon="true" :bgcolor="false"></page-header>
            <div class="dropdown_warp">
                <div class="promote-header">
                    <div class="tab_nav search_area">
                        <van-cell-group>
                            <van-field v-model="mobile" center clearable left-icon="search" placeholder="搜索下级">
                                <template #button>
                ...
                <div class="record_content">
                    <div class="buy_number" v-for="(item,index) in invitlist" :key="index">
                        ...
                        <div class="invit_item2">
                            <p>抽成：<em class="record_cash">5%</em></p>
        ...
        <van-dialog class="set_Model" v-model="dataModel" title="设置佣金比例" :before-close="onBeforeClose">
            <van-icon class="close_btn" name="cross" @click="dataModel=false" />
            <div class="tips_text">设置说明：佣金调整比例<span>1-10%</span></div>
            <div class="custom_dialog">
                <div class="custom_lable">
                    <van-cell-group :border="false">
                        <van-field v-model="divideNum" center clearable maxLength="10" width="100" type="tel" @keyup="heaberBtn" placeholder="请输入分成比例" right-icon="warning-o">
                            <template #right-icon>
                                <div>%</div>
                            </template>
                        </van-field>
